			...
			<div className="map text-center">
				...
				<div className="row text-center">
					<div className="col-xs-12">
						...
						<span>LAYOUT</span><br/>
						<label className="radio-inline"><input type="radio" name="optradio"/>HORIZONTAL</label>
						<label className="radio-inline"><input type="radio" name="optradio"/>VERTICAL</label>
						<table className="table sidebar-table">
							<tbody>
								<tr>
