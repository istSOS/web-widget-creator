...
export const Box = class Box extends Widget {
   ...
   build() {
      ...
      data[this.getProcedure()].observedSpec.forEach((property) => {
         ...
         console.log(WidgetFunctions.getUrlByValue(data[this.getProcedure()].lastObservation.properties[property.name], property.intervals))
         let img = document.createElement('img');
         img.style.maxWidth = '100px';
         img.style.maxHeight = '100px';
         img.setAttribute('src', WidgetFunctions.getUrlByValue(data[this.getProcedure()].lastObservation.properties[property.name], property.intervals));
         ...
         valueCol.innerHTML = data[this.getProcedure()].lastObservation.properties[property.name] + ' ' + property.uom;
