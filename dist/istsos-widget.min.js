(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["istsosWidget"] = factory();
	else
		root["istsosWidget"] = factory();
})(this, function() {
...
exports.build = exports.getCode = exports.olderDate = exports.newerDate = exports.getUrlByValue = undefined;

var _WidgetTypes = __webpack_require__(0);
...
//GET NEWER DATE
var newerDate = function newerDate(date1, date2) {
...
//GET OLDER DATE
var olderDate = function olderDate(date1, date2) {
	var dateTime1 = new Date(date1);
	var dateTime2 = new Date(date2);
	return dateTime1.getTime() - dateTime2.getTime() <= 0 ? dateTime1.toISOString() : dateTime2.toISOString();
};

var getCode = function getCode(config, type) {
...
var updateData = function updateData(widget) {};

var getUrlByValue = function getUrlByValue(value, list) {
...
var build = function build(config, type) {
	var preview = void 0;
	var widget = void 0;
	var code = void 0;
	switch (type) {
		case _WidgetTypes.WidgetTypes.TYPE_MAP:
			widget = new _Map.Map(config);
			widget.build();
			code = getCode(config, _WidgetTypes.WidgetTypes.TYPE_MAP);
			...
			return {
				preview: preview, widget: widget, code: code
			};
			break;
		case _WidgetTypes.WidgetTypes.TYPE_BOX:
			widget = new _Box.Box(config);
			widget.build();
			code = getCode(config, _WidgetTypes.WidgetTypes.TYPE_BOX);
			...
			break;
		case _WidgetTypes.WidgetTypes.TYPE_CHART:
			// statements_1
			break;
		default:
			// statements_def
...
exports.getUrlByValue = getUrlByValue;
exports.newerDate = newerDate;
exports.olderDate = olderDate;
...
var Widget = exports.Widget = function () {
   ...
   _createClass(Widget, [{
      key: "setService",
      value: function setService(serviceName) {
      ...
      key: "setElementId",
      value: function setElementId(id) {
         this.elementId = id;
      }
   }, {
      key: "getElementId",
...
var _Widget2 = __webpack_require__(2);

var _WidgetTypes = __webpack_require__(0);

var _WidgetFunctions = __webpack_require__(1);

var WidgetFunctions = _interopRequireWildcard(_WidgetFunctions);

var _openlayers = __webpack_require__(6);
...
var Map = exports.Map = function (_Widget) {
   _inherits(Map, _Widget);
   ...
   function Map(options) {
      ...
      _this.offering = options.offering || null;
      _this.procedures = options.procedures || [];
      _this.observedProperty = options.property || null;
      _this.dataConfig = options.data || null;
      _this.autoUpdate = {
      ...
      _get(Map.prototype.__proto__ || Object.getPrototypeOf(Map.prototype), 'setType', _this).call(_this, _WidgetTypes.WidgetTypes.TYPE_MAP);
   ...
   _createClass(Map, [{
      key: 'setOffering',
      value: function setOffering(offering) {
      ...
      key: 'setProcedures',
      value: function setProcedures(proceduresList) {
      ...
      key: 'setObservedProperty',
      value: function setObservedProperty(observedProperty) {
      ...
      value: function getObservedProperty() {
      ...
      key: 'setDataConfig',
      value: function setDataConfig(dataConfig) {
      ...
      key: 'setAutoUpdate',
      value: function setAutoUpdate(autoUpdateObj) {
      ...
      key: 'setService',
      value: function setService(serviceName) {
         _get(Map.prototype.__proto__ || Object.getPrototypeOf(Map.prototype), 'setService', this).call(this, serviceName);
      }
      ...
      key: 'getService',
      value: function getService() {
         return _get(Map.prototype.__proto__ || Object.getPrototypeOf(Map.prototype), 'getService', this).call(this);
      }
      ...
      key: 'setHeight',
      value: function setHeight(height) {
         _get(Map.prototype.__proto__ || Object.getPrototypeOf(Map.prototype), 'setHeight', this).call(this, height);
      }
      ...
      key: 'getHeight',
      value: function getHeight() {
         return _get(Map.prototype.__proto__ || Object.getPrototypeOf(Map.prototype), 'getHeight', this).call(this);
      }
      ...
      key: 'setWidth',
      value: function setWidth(width) {
         _get(Map.prototype.__proto__ || Object.getPrototypeOf(Map.prototype), 'setWidth', this).call(this, width);
      }
      ...
      key: 'getWidth',
      value: function getWidth() {
         return _get(Map.prototype.__proto__ || Object.getPrototypeOf(Map.prototype), 'getWidth', this).call(this);
      }
      ...
      key: 'setCssClass',
      value: function setCssClass(cssClass) {
         _get(Map.prototype.__proto__ || Object.getPrototypeOf(Map.prototype), 'setCssClass', this).call(this, cssClass);
      }
      ...
      key: 'getCssClass',
      value: function getCssClass() {
         return _get(Map.prototype.__proto__ || Object.getPrototypeOf(Map.prototype), 'getCssClass', this).call(this);
      }
      ...
      key: 'setType',
      value: function setType(type) {
         this.type = _get(Map.prototype.__proto__ || Object.getPrototypeOf(Map.prototype), 'setType', this).call(this, type);
      }
      ...
      key: 'getType',
      value: function getType() {
         return _get(Map.prototype.__proto__ || Object.getPrototypeOf(Map.prototype), 'getType', this).call(this);
      }
      ...
      key: 'setElementId',
      value: function setElementId(id) {
         _get(Map.prototype.__proto__ || Object.getPrototypeOf(Map.prototype), 'setElementId', this).call(this, id);
      }
      ...
      key: 'getElementId',
      value: function getElementId() {
         return _get(Map.prototype.__proto__ || Object.getPrototypeOf(Map.prototype), 'getElementId', this).call(this);
      }
      ...
      value: function build() {
         ...
         var feature_source = new _openlayers.source.Vector({
            features: []
         });

         for (var sensor in this.dataConfig) {
            if (sensor != 'library_path') {
               var feature = new _openlayers.Feature({
                  geometry: new _openlayers.geom.Point(_openlayers.proj.transform(this.dataConfig[sensor].coordinates, 'EPSG:4326', 'EPSG:3857'))
               });
         ...
         var defaultStyle = new _openlayers.style.Circle({
            radius: 10,
            stroke: new _openlayers.style.Stroke({
               color: '#fff'
            }),
            fill: new _openlayers.style.Fill({
               color: '#3399CC'
            })
         });
         ...
         var that = this;
         var styleCache = {};
         var layers = [new _openlayers.layer.Tile({
            source: new _openlayers.source.OSM()
         }), new _openlayers.layer.Vector({
            source: feature_source,
            style: function style(feature) {
               if (!styleCache[feature.get('name')]) {
                  styleCache[feature.get('name')] = new _openlayers.style.Style({
                     image: new _openlayers.style.Icon({
                        anchor: [0.5, 0.5],
                        offset: [0, 0],
                        scale: 0.25,
                        src: WidgetFunctions.getUrlByValue(feature.get('value'), feature.get('interval'))
                     }),
                     text: new _openlayers.style.Text({
         ...
         var map = new _openlayers.Map({
            target: this.getElementId(),
            loadTilesWhileInteracting: true,
            loadTilesWhileAnimating: true,
            layers: layers,
            view: new _openlayers.View({
               center: _openlayers.proj.transform([22, 44], 'EPSG:4326', 'EPSG:3857'),
               zoom: 6
            })
...
var Box = exports.Box = function (_Widget) {
   _inherits(Box, _Widget);

   function Box(options) {
      _classCallCheck(this, Box);

      var _this = _possibleConstructorReturn(this, (Box.__proto__ || Object.getPrototypeOf(Box)).call(this, options));

      _this.box = null;
      _this.offering = options.offering || null;
      _this.procedure = options.procedure || null;
      _this.observedProperties = options.properties || [];
      _this.dataConfig = options.data || null;
      _this.verticalLayout = options.layout == 'horizontal' ? false : true;
      _this.autoUpdate = {
         active: options.auto_update,
         time_unit: options.time_unit || null,
         start_delay: options.start_delay || null,
      ...
      _get(Box.prototype.__proto__ || Object.getPrototypeOf(Box.prototype), 'setType', _this).call(_this, _WidgetTypes.WidgetTypes.TYPE_MAP);
   ...
   _createClass(Box, [{
      ...
      key: 'setProcedure',
      value: function setProcedure(procedure) {
      ...
      key: 'setObservedProperties',
      value: function setObservedProperties(observedProperties) {
      ...
      key: 'setService',
      value: function setService(serviceName) {
         _get(Box.prototype.__proto__ || Object.getPrototypeOf(Box.prototype), 'setService', this).call(this, serviceName);
      }
      ...
      key: 'getService',
      value: function getService() {
         return _get(Box.prototype.__proto__ || Object.getPrototypeOf(Box.prototype), 'getService', this).call(this);
      }
      ...
      key: 'setHeight',
      value: function setHeight(height) {
         _get(Box.prototype.__proto__ || Object.getPrototypeOf(Box.prototype), 'setHeight', this).call(this, height);
      }
      ...
      key: 'getHeight',
      value: function getHeight() {
         return _get(Box.prototype.__proto__ || Object.getPrototypeOf(Box.prototype), 'getHeight', this).call(this);
      }
      ...
      key: 'setWidth',
      value: function setWidth(width) {
         _get(Box.prototype.__proto__ || Object.getPrototypeOf(Box.prototype), 'setWidth', this).call(this, width);
      }
      ...
      key: 'getWidth',
      value: function getWidth() {
         return _get(Box.prototype.__proto__ || Object.getPrototypeOf(Box.prototype), 'getWidth', this).call(this);
      }
      ...
      key: 'setCssClass',
      value: function setCssClass(cssClass) {
         _get(Box.prototype.__proto__ || Object.getPrototypeOf(Box.prototype), 'setCssClass', this).call(this, cssClass);
      }
      ...
      key: 'getCssClass',
      value: function getCssClass() {
         return _get(Box.prototype.__proto__ || Object.getPrototypeOf(Box.prototype), 'getCssClass', this).call(this);
      }
      ...
      key: 'setType',
      value: function setType(type) {
         this.type = _get(Box.prototype.__proto__ || Object.getPrototypeOf(Box.prototype), 'setType', this).call(this, type);
      }
      ...
      key: 'getType',
      value: function getType() {
         return _get(Box.prototype.__proto__ || Object.getPrototypeOf(Box.prototype), 'getType', this).call(this);
      }
      ...
      key: 'setElementId',
      value: function setElementId(id) {
         _get(Box.prototype.__proto__ || Object.getPrototypeOf(Box.prototype), 'setElementId', this).call(this, id);
      }
      ...
      key: 'getElementId',
      value: function getElementId() {
         return _get(Box.prototype.__proto__ || Object.getPrototypeOf(Box.prototype), 'getElementId', this).call(this);
      }
      ...
      value: function build() {
         ...
         var procedureName = document.createElement('div');
         ...
         var gmt = document.createElement('div');
         ...
         data[this.getProcedure()].observedSpec.forEach(function (property) {
            ...
            console.log(WidgetFunctions.getUrlByValue(data[_this2.getProcedure()].lastObservation.properties[property.name], property.intervals));
            var img = document.createElement('img');
            img.style.maxWidth = '100px';
            img.style.maxHeight = '100px';
            img.setAttribute('src', WidgetFunctions.getUrlByValue(data[_this2.getProcedure()].lastObservation.properties[property.name], property.intervals));
            ...
            var propertyCol = document.createElement('td');
            propertyCol.innerHTML = property.display + ': ';

            var valueCol = document.createElement('td');
            valueCol.innerHTML = data[_this2.getProcedure()].lastObservation.properties[property.name] + ' ' + property.uom;
...
module.exports = {
   WidgetFunctions: {
      newerDate: _WidgetFunctions.newerDate,
      olderDate: _WidgetFunctions.olderDate,
      getCode: _WidgetFunctions.getCode,
      build: _WidgetFunctions.build
   },
   WidgetTypes: {
      TYPES_INFO: _WidgetTypes.TYPES_INFO,
      TYPE_MAP: _WidgetTypes.TYPE_MAP,
      TYPE_BOX: _WidgetTypes.TYPE_BOX,
      TYPE_CHART: _WidgetTypes.TYPE_CHART
   },
