...
var _Widget2 = __webpack_require__(1);
...
var Map = exports.Map = function (_Widget) {
   ...
   _createClass(Map, [{
      ...
      value: function build() {
         ...
         var cluster_source = new _openlayers.source.Vector({
            distance: 150,
         ...
         var layers = [new _openlayers.layer.Tile({
            ...
            style: function style(feature) {
               var style = new _openlayers.style.Style({
                  image: new _openlayers.style.Circle({
                     radius: 10,
...
var _WidgetFunctions = __webpack_require__(5);
...
exports.build = exports.getCode = exports.olderDate = exports.newerDate = undefined;
