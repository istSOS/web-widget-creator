...
var _WidgetTypes2 = _interopRequireDefault(_WidgetTypes);
...
var Map = exports.Map = function (_Widget) {
   ...
   function Map(options) {
      ...
      _this.observedProperty = options.observedProperty || null;
      _this.dataConfig = options.dataConfig || null;
      _this.autoUpdate = {
      ...
      _get(Map.prototype.__proto__ || Object.getPrototypeOf(Map.prototype), 'setType', _this).call(_this, _WidgetTypes2.default.TYPE_MAP);
...
var _WidgetFunctions = __webpack_require__(4);
...
var getCode = function getCode(config) {
...
var build = function build(config, type) {
	...
	var widget = void 0;
	switch (type) {
		case _WidgetTypes2.default.TYPE_MAP:
			widget = new _Map.Map(config);
			widget.build();
			var code = getCode(widget.getConfig());
			...
			break;
		case _WidgetTypes2.default.TYPE_BOX:
			// statements_1
			break;
		case _WidgetTypes2.default.TYPE_CHART:
			// statements_1
			break;
		default:
			// statements_def
